...
| 部分完成 | 共享网盘浏览文案资源化 | `3dbc437` | `CloudBrowserScreen`、加载更多、多选、分页、删除确认和处理中 UI 已迁移；账号卡片、操作表、夸克旧浏览实现和平台专属页面仍待迁移 |
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析 `8a47977`/`3c6b563`、设置 `61440b7`/`8675355`/`fb83595`/`53e0990`、共享浏览 `3dbc437`；账号卡片、操作表和平台专属页面待迁移】
