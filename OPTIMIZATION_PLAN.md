...
| 部分完成 | 设置业务域文案资源化 | `61440b7`、`8675355` | 主题、更新、日志导出和账号备份已迁移；下载参数、电池优化和关于/支持入口仍待迁移 |
...
4. 设置页、备份、更新和电池优化提示。【部分完成：主题/更新 `61440b7`、日志/备份 `8675355`】
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析 `8a47977`/`3c6b563`、设置 `61440b7`/`8675355`】
