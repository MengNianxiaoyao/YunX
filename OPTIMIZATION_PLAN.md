...
| 部分完成 | 共享网盘浏览文案资源化 | `3dbc437`、`40bb026`、待提交 | `CloudBrowserScreen`、加载更多、多选、分页、删除确认、处理中 UI、`CloudAccountSheet`、`CloudActionSheets`、`CloudSaveSheet`、`CloudDriveScreen` 和 `DriveScreen` 账号卡片已迁移；六个平台专属登录/分享页面仍待迁移 |
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析 `8a47977`/`3c6b563`、设置 `61440b7`/`8675355`/`fb83595`/`53e0990`、共享浏览 `3dbc437`/`40bb026`/待提交；六个平台专属登录/分享页面待迁移】
