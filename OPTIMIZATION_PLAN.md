...
| 部分完成 | 解析业务域文案资源化 | `8a47977` | 解析输入、剪贴板提示、分享详情、多选、分页、批量进度、面包屑与无障碍文案已迁移；ViewModel 错误和反馈仍待类型化 `UiText` |
...
3. 解析页、链接提示、解析错误和批量操作进度。【部分完成：页面与批量进度 `8a47977`；ViewModel 错误待迁移】
4. 设置页、备份、更新和电池优化提示。
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析页面 `8a47977`】
