...
| 部分完成 | 设置业务域文案资源化 | `61440b7` | 主题页、更新弹窗及设置页外观/检查更新入口已迁移；下载参数、日志、备份、电池优化和关于入口仍待迁移 |
...
4. 设置页、备份、更新和电池优化提示。【部分完成：主题与更新 `61440b7`】
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析 `8a47977`/`3c6b563`、主题与更新 `61440b7`】
