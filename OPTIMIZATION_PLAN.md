...
| 部分完成 | 共享网盘浏览文案资源化 | `3dbc437`、`40bb026`、`8312a0a`、`d9a67a4`、`e400a6c`、待提交 | `CloudBrowserScreen`、加载更多、多选、分页、删除确认、处理中 UI、`CloudAccountSheet`、`CloudActionSheets`、`CloudSaveSheet`、`CloudDriveScreen`、`DriveScreen` 账号卡片、五个平台共享浏览/分享页面及 `CloudFileSheets`（含批量操作和分享结果）已迁移；收藏页和平台登录页仍待迁移 |
...
2. 迁移公共导航、操作和状态文案。
3. 迁移下载、解析、设置和平台页面。【部分完成：下载 `262f320`、解析 `8a47977`/`3c6b563`、设置 `61440b7`/`8675355`/`fb83595`/`53e0990`、共享浏览 `3dbc437`/`40bb026`/`8312a0a`/`d9a67a4`/`e400a6c`/待提交（含五个平台分享页和 `CloudFileSheets`）；收藏页和平台登录页待迁移】
